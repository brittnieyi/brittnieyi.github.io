...
Lines 11-22 for data sources, Lines 31-51 for importing the data
...
Lines 71, 83, 90, 101-106, 126-127, 160-161, 181-187
...
Lines 133-134, 143-145, 165-167, 192, 195

(B) .Rmd Line number(s) for use of multiple aesthetics:  

Lines 132, 133, 142, 143, 164, 165, 191, 192
